...
describe('Responsive Type', () => {
  it('should output expected with only min value', () => {
    const output1 = responsiveType('6vw', '3em').join('');
    const output2 = responsiveType('5vw', '2.6em').join('');
  ...
  it('should output expected with min and max value', () => {
    const output1 = responsiveType('6vw', '3em', '4em').join('');
    const output2 = responsiveType('5vw', '2.6em', '3.33333em').join('');
  ...
  it('should output expected with min, max and fallback value', () => {
    const output1 = responsiveType('6vw', '3em', '4em', '3.5em').join('');
    const output2 = responsiveType('5vw', '2.6em', '3.33333em', '2.966665em').join('');
    expect(output1).toEqual(
